...
class KeypointLoss(nn.Module):
    ...
    def forward(self, pred_kpts, gt_kpts, kpt_mask, area):
        ...
        **Modified Implementation:**
        ...
        d_first_4 = (pred_kpts_1234[..., 0] - gt_kpts_1234[..., 0]).pow(2) + (
            pred_kpts_1234[..., 1] - gt_kpts_1234[..., 1]
        ).pow(2)
        ...
        d_567 = (pred_kpts_aligned[..., 0] - gt_kpts_567[..., 0]).pow(2) + (
            pred_kpts_aligned[..., 1] - gt_kpts_567[..., 1]
        ).pow(2)
